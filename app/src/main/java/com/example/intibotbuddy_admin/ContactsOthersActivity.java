...
public class ContactsOthersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contacts_others);

        String category = getString(R.string.button_contacts);
        setTitle(category.toUpperCase());

        ProgressBar progressBar = findViewById(R.id.progressBarContactsOthers);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.contactsOthersListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID54.php";
                    ...
                    Log.e("ContOthersActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] contOthers = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            contOthers[i] = jsonObject.getString(String.valueOf(i+1));
