...
public class AfmHelpdeskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afm_helpdesk);

        String category = getString(R.string.button_helpdesksOtherEnquiries);
        setTitle(category.toUpperCase());

        ProgressBar progressBar = findViewById(R.id.progressBarAfmHelpdesk);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.afmHelpdeskListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID72.php";
                    ...
                    Log.e("AfmHelpActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] afmHelpdesk = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            afmHelpdesk[i] = jsonObject.getString(String.valueOf(i+1));
