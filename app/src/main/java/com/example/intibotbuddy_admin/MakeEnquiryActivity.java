...
public class MakeEnquiryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar progressBar = findViewById(R.id.progressBarMakeEnquiry);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.makeEnquiryListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID74.php";
                    ...
                    Log.e("EnquiryActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] makeEnquiry = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            makeEnquiry[i] = jsonObject.getString(String.valueOf(i+1));
