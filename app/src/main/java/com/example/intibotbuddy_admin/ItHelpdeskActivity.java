...
public class ItHelpdeskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_it_helpdesk);

        String category = getString(R.string.button_helpdesksOtherEnquiries);
        setTitle(category.toUpperCase());

        ProgressBar progressBar = findViewById(R.id.progressBarItHelpdesk);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.itHelpdeskListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID71.php";
                    ...
                    Log.e("ItHelpActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] itHelpdesk = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            itHelpdesk[i] = jsonObject.getString(String.valueOf(i+1));
