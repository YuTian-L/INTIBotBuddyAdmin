...
public class ClubsSocietiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar progressBar = findViewById(R.id.progressBarClubsSocieties);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.clubsSocietiesListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID62.php";
                    ...
                    Log.e("ClubsSociActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] clubsSocieties = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            clubsSocieties[i] = jsonObject.getString(String.valueOf(i+1));
