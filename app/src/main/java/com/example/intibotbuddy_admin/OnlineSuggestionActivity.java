...
public class OnlineSuggestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_online_suggestion);

        String category = getString(R.string.button_helpdesksOtherEnquiries);
        setTitle(category.toUpperCase());

        ProgressBar progressBar = findViewById(R.id.progressBarOnlineSuggestion);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.onlineSuggestionListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID73.php";
                    ...
                    Log.e("SuggestionActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] onlineSuggestion = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            onlineSuggestion[i] = jsonObject.getString(String.valueOf(i+1));
