...
public class CounsellingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.counsellingListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID13.php";
                    ...
                    Log.e("CounselingActivityError", e.getLocalizedMessage());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent_add = new Intent(this, AddCounsellingActivity.class);
                startActivity(intent_add);
                return true;

            case R.id.action_edit:
                Intent intent_edit = new Intent(this, EditCounsellingActivity.class);
                startActivity(intent_edit);
                return true;

            case R.id.action_delete:
                Intent intent_del = new Intent(this, DeleteCounsellingActivity.class);
