...
public class DeleteEmergencyBgActivity extends AsyncTask {

    private Context context;

    public DeleteEmergencyBgActivity(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String link = "http://pkunite2.000webhostapp.com/deleteID12.php";
            ...
            Log.e("DelEmergeActivityError", e.getLocalizedMessage());
