...
public class EditCounsellingBgActivity extends AsyncTask {

    private Context context;

    public EditCounsellingBgActivity(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String link = "http://pkunite2.000webhostapp.com/editID13.php";
            ...
            Log.e("EdtCounselActivityError", e.getLocalizedMessage());
