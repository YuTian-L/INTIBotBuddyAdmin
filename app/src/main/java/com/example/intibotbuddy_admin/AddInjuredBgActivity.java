...
public class AddInjuredBgActivity extends AsyncTask {

    private Context context;

    public AddInjuredBgActivity(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String link = "http://pkunite2.000webhostapp.com/addID11.php";
            ...
            Log.e("AddInjuredActivityError", e.getLocalizedMessage());
