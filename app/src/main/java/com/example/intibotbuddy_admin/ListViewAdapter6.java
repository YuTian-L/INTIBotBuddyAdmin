...
public class ListViewAdapter6 extends ArrayAdapter<Info6> {
    private final Context context;
    private final ArrayList<Info6> items;

    public ListViewAdapter6(@NonNull Context context, ArrayList<Info6> items) {
        super(context, R.layout.listview_layout6, items);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.listview_layout6, parent, false);
