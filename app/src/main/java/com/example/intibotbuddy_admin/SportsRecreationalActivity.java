...
public class SportsRecreationalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_recreational);

        String category = getString(R.string.button_facilitiesLocations);
        setTitle(category.toUpperCase());

        ProgressBar progressBar = findViewById(R.id.progressBarSportsRecreational);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.sportsRecreationalListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID44.php";
                    ...
                    Log.e("SportsRecActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] sportsRec = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            sportsRec[i] = jsonObject.getString(String.valueOf(i+1));
