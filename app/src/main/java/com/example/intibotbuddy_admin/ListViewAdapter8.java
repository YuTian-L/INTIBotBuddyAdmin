...
public class ListViewAdapter8 extends ArrayAdapter<Info8> {
    private final Context context;
    private final ArrayList<Info8> items;

    public ListViewAdapter8(@NonNull Context context, ArrayList<Info8> items) {
        super(context, R.layout.listview_layout8, items);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.listview_layout8, parent, false);
