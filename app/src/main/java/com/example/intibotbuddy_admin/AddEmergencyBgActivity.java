...
public class AddEmergencyBgActivity extends AsyncTask {

    private Context context;

    public AddEmergencyBgActivity(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String link = "http://pkunite2.000webhostapp.com/addID12.php";
            ...
            Log.e("AddEmergeActivityError", e.getLocalizedMessage());
