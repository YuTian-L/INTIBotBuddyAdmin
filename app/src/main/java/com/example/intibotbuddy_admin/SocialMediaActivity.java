...
public class SocialMediaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar progressBar = findViewById(R.id.progressBarSocialMedia);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.socialListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID23.php";
                    ...
                    Log.e("SocialActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] social = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            social[i] = jsonObject.getString(String.valueOf(i+1));
