...
public class DeleteInjuredBgActivity extends AsyncTask {

    private Context context;

    public DeleteInjuredBgActivity(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String link = "http://pkunite2.000webhostapp.com/deleteID11.php";
            ...
            Log.e("DelInjuredActivityError", e.getLocalizedMessage());
