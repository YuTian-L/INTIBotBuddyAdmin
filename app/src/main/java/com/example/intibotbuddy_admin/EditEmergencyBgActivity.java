...
public class EditEmergencyBgActivity extends AsyncTask {

    private Context context;

    public EditEmergencyBgActivity(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            String link = "http://pkunite2.000webhostapp.com/editID12.php";
            ...
            Log.e("EdtEmergeActivityError", e.getLocalizedMessage());
