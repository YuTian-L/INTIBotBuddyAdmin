...
public class GetInTouchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar progressBar = findViewById(R.id.progressBarGetInTouch);
        progressBar.setVisibility(ProgressBar.VISIBLE);

        listView = findViewById(R.id.getInTouchListView);
        getJSON();
    }
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, Object> {
            ...
            protected Object doInBackground(Void... voids) {
                try {
                    String link = "http://pkunite2.000webhostapp.com/getID21.php";
                    ...
                    Log.e("GetInTouchActivityError", e.getLocalizedMessage());
    ...
    private void loadIntoListView(String line) throws JSONException {
        ...
        String[] getInTouch = new String[jsonObject.length()];
        Map<String, String> details = new HashMap<>();

        for (int i=0; jsonObject.has(String.valueOf(i+1)); i++){
            getInTouch[i] = jsonObject.getString(String.valueOf(i+1));
